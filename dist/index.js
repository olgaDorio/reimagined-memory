  ...
  const changes = (object, base) => {
    return Object(lodash["transform"])(object, (result, value, key) => {
      if (!Object(lodash["isEqual"])(value, base[key])) {
        result[key] = Object(lodash["isObject"])(value) && Object(lodash["isObject"])(base[key]) ? changes(value, base[key]) : value;
      }
    });
  };
...
/* harmony default export */ var index = __webpack_exports__["default"] = (createInstance);
